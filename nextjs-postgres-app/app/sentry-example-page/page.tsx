    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://sentry.example.cn/organizations/sentry/issues/?project=4">Issues Page</a>.
